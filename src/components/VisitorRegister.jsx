        ...
        <div className='flex p-8 flex-col h-full'>
            <div className='flex items-center mb-8 p-2'>
                ...
                <div className='flex items-start ml-4 flex-col'>
                    <h2 className='font-bold text-lg m-0'>BulSU Bustos Facys</h2>
                    <p className='font-normal text-sm m-0'>Vistor Registration</p>
                </div>
                </a>
            </div>
            ...
            <div className='flex justify-center flex-col items-center mt-8 gap-4 w-full h-full'>
                {
                    !visitorFaceData3 && (
                        <div className='w-full p-4 h-full rounded'>
                            {
                                !start && (
                ...
                <div className='w-full justify-center items-center h-fit flex flex-col gap-4'>
                    {
                ...
                </div>
                {
                    visitorFaceData3 && (
                        <div className='w-2/3 h-fit flex flex-col gap-4'>
                            ...
                            <button onClick={handleSubmit} className="p-2 w-full bg-red-500 text-white rounded">Register</button>
                        </div>
                    )
                }
            </div>
